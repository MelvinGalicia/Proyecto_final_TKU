...
// Comprobando si la persona es menor de edad
var edad_numero = parseInt(edad);
if (edad_numero < 18) {
    alert("Lo sentimos, la persona a asegurar debe ser mayor de edad.");
    // Detener el programa
    throw new Error("La persona a asegurar es menor de edad.");
}
var casado = prompt("¿Está casado actualmente?","sí,no")
//Comprobamos la edad del cónyuge, solamente si se está casado/a
var edad_conyuge
if("SI" == casado.toUpperCase()){
  edad_conyuge = prompt("¿Qué edad tiene su esposo/a?", "ingrese la cantidad")
}
...
if("SI" == hijos.toUpperCase()){
  cantidad_hijos = prompt("¿Cuántos hijos tiene?", "ingrese la cantidad")
}
//convirtiendo la cantidad de hijos a número 
var hijos_numero = parseInt(hijos)
var cantidad_hijos_numero = 0
//convirtiendo la cantidad de hijos si los tiene
if("SI" == hijos.toUpperCase()){
